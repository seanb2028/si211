...
public class Box
{
    ...
    public Box(Point p) { 
        l_l = new Point(p.pnt_x, p.pnt_y);
        u_l = new Point(p.pnt_x, p.pnt_y);
    }

    // constructor for Box taking two initial points
    public Box(Point a, Point b) {
        l_l = new Point(Math.min(a.pnt_x, b.pnt_x), Math.min(a.pnt_y, b.pnt_y));
    ...
    public String toString() {
        return l_l.pnt_x + " < x < " + u_l.pnt_y + ", " + l_l.pnt_y + " < y < " + u_l.pnt_y;
    }
